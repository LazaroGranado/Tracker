...
function MyProjects() {
  ...
  const [initialDefaultImage, setInitialDefaultImage] = useState();
          ...
          if (userId) {
            axios
              ...
              .then((r) => {
                ...
                setInitialArchivedStatus(r.data.projects.archived);
                setInitialDefaultImage(r.data.defaultImage);
                setIsLoading(false);
              });
          }
        };
  ...
  function ProjectsTable() {
    ...
    useEffect(() => {
      ...
      setDefaultImage(initialDefaultImage && initialDefaultImage);
    }, []);
