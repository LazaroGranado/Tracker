    ...
    getAccessTokenSilently({ detailedResponse: true })
      .then((r) => {
        const decodeIdToken = async () => {
          ...
          if (userId) {
            axios
              .post(process.env.REACT_APP_SERVER + "/Projects/Archived", {
                auth0Id: userId,
              })
              .then((r) => {
                ...
                axios
                  .post(
                    process.env.REACT_APP_SERVER +
                      "/projects/Archived/ArchivedStatus",
                    {
                      userId: auth0Id,
                      projectId: projectId,
                      archived: isArchived,
                ...
                onClick={(e) => {
                  axios
                    ...
                    .then((r) => {
                      axios
                        .post(
                          process.env.REACT_APP_SERVER + "/Projects/Archived",
                          {
                            auth0Id: auth0Id,
                          }
                        )
